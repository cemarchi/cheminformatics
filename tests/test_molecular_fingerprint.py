...
class TestMolecularFingerprint(unittest.TestCase):
    
    def test_create_atom_pair_returns_atom_pair_fingerprint(self):
        molecular_fingerprint = MolecularFingerprint()
        phenylephrine_cononical_smiles = 'CNC[C@H](O)c1cccc(O)c1'

        atom_pair_fingerprint = molecular_fingerprint.create_atom_pair(phenylephrine_cononical_smiles)
    ...
    def test_create_atom_pair_returns_none(self):
        ...
        atom_pair_fingerprint = molecular_fingerprint.create_atom_pair(invalid_smiles)
    ...
    def test_create_maccs_returns_maccs_fingerprint(self):
        ...
        maccs_fingerprint = molecular_fingerprint.create_maccs(phenylephrine_cononical_smiles)
    ...
    def test_create_maccs_returns_none(self):
        ...
        maccs_fingerprint = molecular_fingerprint.create_maccs(invalid_smiles)
    ...
    def test_create_extended_connectivity_returns_extended_connectivity_fingerprint(self):
        ...
        extended_connectivity_fingerprint = molecular_fingerprint.create_extended_connectivity(phenylephrine_cononical_smiles)
    ...
    def test_extended_connectivity_returns_none(self):
        ...
        extended_connectivity_fingerprint = molecular_fingerprint.create_extended_connectivity(invalid_smiles)
    ...
    def test_create_feature_based_morgan_returns_feature_based_morgan_fingerprint(self):
        ...
        feature_based_morgan_fingerprint = molecular_fingerprint.create_feature_based_morgan(phenylephrine_cononical_smiles)
    ...
    def test_create_feature_based_morgan_returns_none(self):
        ...
        feature_based_morgan_fingerprint = molecular_fingerprint.create_feature_based_morgan(invalid_smiles)
    ...
    def test_create_topological_torsion_returns_topological_torsion_fingerprint(self):
        ...
        topological_torsion_fingerprint = molecular_fingerprint.create_topological_torsion(phenylephrine_cononical_smiles)
    ...
    def test_create_topological_torsion_returns_none(self):
        ...
        topological_torsion_fingerprint = molecular_fingerprint.create_topological_torsion(invalid_smiles)

        self.assertIsNone(topological_torsion_fingerprint)

    def test_create_avalon_count_returns_avalon_count_fingerprint(self):
        molecular_fingerprint = MolecularFingerprint()
        phenylephrine_cononical_smiles = 'CNC[C@H](O)c1cccc(O)c1'

        avalon_count_fingerprint = molecular_fingerprint.create_avalon_count(phenylephrine_cononical_smiles)
    ...
    def test_create_avalon_count_returns_none(self):
        ...
        avalon_count_fingerprint = molecular_fingerprint.create_avalon_count(invalid_smiles)
